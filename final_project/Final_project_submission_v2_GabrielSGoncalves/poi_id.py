...
# Concatenate PCA columns to df_enron
...
X = scaler.fit_transform(df_features_no_outliers[features_list].drop('poi', axis=1))
...
my_dataset.set_index = df_features_no_outliers.index
